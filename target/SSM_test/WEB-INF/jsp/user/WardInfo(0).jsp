...
<div id="panelwrap">
    ...
    <div class="center_content">
            ...
            <div id="right_content">
                ...
                <div id="tab1" class="tabcontent">
                    <div class="form">
                        ...
                        <div class="form_row">
                            <label>剩余床位数：</label> <input type="text" class="form_input"
                                                         value="${bed_num}" name="" readonly="readonly"
                                                         style="width: 20%"/>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <table id="rounded-corner" style="text-align: center">
                        ...
                        <tbody>
                        <c:forEach items="${patients}" var="wardmate" varStatus="cnt">
                        <tr class="odd">
                            <td>${wardmate.bed_id}
                            </td>
                            <td>${wardmate.patient_name}
                            </td>
                            <td>${wardmate.patient_sex}
                            </td>
                            <td>${wardmate.patient_age}
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul>
                <li><a href="WardInfo" class="selected">病房信息</a></li>
