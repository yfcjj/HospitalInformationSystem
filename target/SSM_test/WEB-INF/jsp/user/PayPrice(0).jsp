    ...
    <div class="center_content">
        <div id="right_wrap">
            <div id="right_content">
                ...
                <div id="tab1" class="tabcontent">
                    <div class="form">
                        <div class="form_row">
                            <label>挂号费用（元）：</label> <input type="text" class="form_input"
                                                           value="${register_price}" name="" readonly="readonly"
                                                           style="width: 20%"/>
                        </div>
                        <div class="form_row">
                            <label>住院费用（元）：</label> <input type="text" class="form_input"
                                                           value="${host_ex}" name="" readonly="readonly"
                                                           style="width: 20%"/>
                        </div>
                        <div class="form_row">
                            <label>治疗费用（元）：</label> <input type="text" class="form_input"
                                                           value="${treat_ex}" name="" readonly="readonly"
                                                           style="width: 20%"/>
                        </div>
                        <div class="form_row">
                            <label>检验费用（元）：</label> <input type="text" class="form_input"
                                                           value="${report_ex}" name="" readonly="readonly"
                                                           style="width: 20%"/>
                        </div>
                        <div class="form_row">
                            <label>总计（元）：</label> <input type="text" class="form_input"
                                                         value="${sum_ex}" name="" readonly="readonly"
                                                         style="width: 20%"/>
                        </div>
                        <div class="clear"></div>
                    </div>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul>
                ...
                <li><a href="PayPrice" class="selected">费用缴纳</a></li>
