...
<div id="panelwrap">
    ...
    <div class="center_content">
                ...
                <div id="tab1" class="tabcontent">
                    <table id="rounded-corner" style="text-align: center">
                        ...
                        <tr class="odd">
                            ...
                            <td><fmt:formatDate value="${pat.in_time}" pattern="yyyy-MM-dd"></fmt:formatDate>
                            </td>
                            <td><fmt:formatDate value="${pat.out_time}" pattern="yyyy-MM-dd"></fmt:formatDate>
                            </td>
                            <td>${pat.doctor_id}
                            </td>
                            <td>${pat.bed_id}
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul>
                <li><a href="AdminPatientInfo" class="selected">病人</a></li>
    ...
    <div class="footer">CopyRight©2022 医院住院管理系统8</div>
