    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#adddoctor").submit(function () {
                ...
                $.ajax({
                    url: "/AdminAddNewDoctor",
                    type: "post",
                    data: {
                        doctor_id: x.split("&")[1].split("=")[1],
                        doctor_name: x.split("&")[0].split("=")[1],
                        doctor_sex: x.split("&")[2].split("=")[1],
                        doctor_age: x.split("&")[3].split("=")[1],
                        doctor_ph: x.split("&")[4].split("=")[1],
                        department_id: x.split("&")[5].split("=")[1],
                        introduction: x.split("&")[6].split("=")[1]
                    },
                    success: function () {
                        alert("添加新医生成功");
...
<div id="panelwrap">
    ...
    <div class="center_content">
            ...
            <div id="right_content">
                ...
                <div id="tab1" class="tabcontent">
                    ...
                    <form action="" class="form1" method="post" name="form3"
                          id="adddoctor" accept-charset="utf-8">
                        <div class="form">
                            <div class="form_row">
                                <label>姓名：</label> <input type="text" class="form_input"
                                                          name="doctor_name" style="width: 20%"/>
                            </div>

                            <div class="form_row">
                                <label>工作编号：</label> <input type="text" class="form_input"
                                                            name="doctor_id" style="width: 40%"/>
                            </div>
                            <div class="form_row">
                                <label>性别：</label> <input type="text" class="form_input"
                                                          name="doctor_sex" style="width: 10%;margin-right: 20px"/>
                            </div>
                            <div class="form_row">
                                <label>年龄：</label> <input type="text" class="form_input"
                                                          name="doctor_age" style="width: 10%;float:left;"/>
                            </div>
                            <div class="form_row">
                                <label>联系方式：</label> <input type="text" class="form_input"
                                                            name="doctor_ph" style="width: 40%"/>
                            </div>
                            <div class="form_row">
                                <label>科室：</label> <select class="form_select"
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul>
                <li><a href="AdminAddDoctor" class="selected">医生录入</a></li>
